...
libname tbstest '/sasdata/StudioTopLevel/Projects/S6_CHT_TBSTest';
...
SELECT DISTINCT Lineage, StartTime, BeltSpeedSetpoint AS BeltSpeed
FROM SINGLE.ME_DEP_CHT_M8CIMData
...
SELECT a.*
FROM SINGLE.ME_DEP_CHT_M8CIMData a
...
filename pScore "/sasdata/StudioTopLevel/Projects/S6_CHT_TBSTest/&lineage._&&position&j.._zone&i._m&k..sas";
...
%PUT &Model1;
%CHECK(/sasdata/StudioTopLevel/Projects/S6_CHT_TBSTest/&Model1.);
...
%PUT &Model2;
%CHECK(/sasdata/StudioTopLevel/Projects/S6_CHT_TBSTest/&Model2.);
...
DATA tbstest.&Lineage._Multi_FitStats;
