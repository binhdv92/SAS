...
libname multi '/sasdata/StudioTopLevel/Projects/S6_CHT_MultiTest';
...
select distinct a.*,b.&&position&j.._P_Mean, c.ProfileID, c.BeltSpeedSetpoint, c.Volume
...
filename pScore "/sasdata/StudioTopLevel/Projects/S6_CHT_MultiTest/&lineage._&&position&j.._zone&i._m&k..sas";

PROC REGSELECT DATA=PUBLIC.&&position&j.._Zone&i.;
MODEL &&position&j.._P_Mean = BeltSpeedSetpoint Volume col1-col%SYSEVALF(12*&i-2) @2;
...
%PUT &Model1;
%CHECK(/sasdata/StudioTopLevel/Projects/S6_CHT_MultiTest/&Model1.);
...
%PUT &Model2;
%CHECK(/sasdata/StudioTopLevel/Projects/S6_CHT_MultiTest/&Model2.);
...
DATA multi.&Lineage._Multi_FitStats;
